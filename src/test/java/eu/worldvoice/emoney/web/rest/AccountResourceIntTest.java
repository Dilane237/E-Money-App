package eu.worldvoice.emoney.web.rest;

import eu.worldvoice.emoney.EmoneyApp;
import eu.worldvoice.emoney.config.Constants;
import eu.worldvoice.emoney.domain.Authority;
import eu.worldvoice.emoney.domain.PersistentToken;
import eu.worldvoice.emoney.domain.User;
import eu.worldvoice.emoney.repository.AuthorityRepository;
import eu.worldvoice.emoney.repository.PersistentTokenRepository;
import eu.worldvoice.emoney.repository.UserRepository;
import eu.worldvoice.emoney.security.AuthoritiesConstants;
import eu.worldvoice.emoney.service.MailService;
import eu.worldvoice.emoney.service.UserService;
import eu.worldvoice.emoney.service.dto.PasswordChangeDTO;
import eu.worldvoice.emoney.service.dto.UserDTO;
import eu.worldvoice.emoney.web.rest.errors.ExceptionTranslator;
import eu.worldvoice.emoney.web.rest.vm.KeyAndPasswordVM;
import eu.worldvoice.emoney.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = EmoneyApp.class)
